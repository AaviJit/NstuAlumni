...
//    }
    ...
    public static String getNameOfDay(int day) {
        switch (day) {
            case 1:
                return Constants.DaysOfWeek.SUNDAY;
            case 2:
                return Constants.DaysOfWeek.MONDAY;
            case 3:
                return Constants.DaysOfWeek.TUESDAY;
            case 4:
                return Constants.DaysOfWeek.WEDNESDAY;
            case 5:
                return Constants.DaysOfWeek.THURSDAY;
            case 6:
                return Constants.DaysOfWeek.FRIDAY;
            case 7:
                return Constants.DaysOfWeek.SATURDAY;
        }
